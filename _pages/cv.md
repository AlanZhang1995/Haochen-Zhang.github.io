...
* **Auto-aggressive conversational image generation**, June 2024 – Nov. 2024
  ...
  * To support non-Markov multi-round personalization, we introduce a chat-history caching mechanism and constructs the first name-based multi-round personalization dataset from video clips, enabling the model to reason jointly over past text and image context.
