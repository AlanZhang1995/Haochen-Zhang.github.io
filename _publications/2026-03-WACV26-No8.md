...
{% include image.html url="/Haochen-Zhang.github.io/images/pub_wacv26_ds.png" description="(a) Example of name-based multi-round personalization. The 1st round is T2I generation. The 2nd and 3rd round of personalization leverages both the textual input and visual output from round one for person description and appearance, respectively. (b) Illustration of the process for deriving multi-round data from video." %}
...
Please also see our arXiv paper with **non-Markov multi-round editting extention** [Here](https://arxiv.org/abs/2601.20911).

[Paper](https://alanzhang1995.github.io/Haochen-Zhang.github.io/files/WACV26_paper.pdf) &#124; [Slides](https://alanzhang1995.github.io/Haochen-Zhang.github.io/files/WACV26_slide.pdf) &#124; [Poster](https://alanzhang1995.github.io/Haochen-Zhang.github.io/files/WACV26_poster.pdf) &#124; [Video](https://www.youtube.com/watch?v=fHTx2LNk3ko)
