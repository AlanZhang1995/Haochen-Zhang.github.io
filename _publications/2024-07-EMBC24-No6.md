...
\begin{equation}
\begin{aligned}
\mathcal{L}_{\text{CycleGAN}}(x,y)
&= \mathcal{L}_{\text{cyc}}(x,\tilde{x})
 + \mathcal{L}_{\text{cyc}}(y,\tilde{y}) \\
&\quad + \alpha \Big(
\mathcal{L}_{\text{GAN}}(x,\hat{x})
+ \mathcal{L}_{\text{GAN}}(y,\hat{y})
\Big) \\
&\quad + \beta \Big(
\mathcal{L}_{\text{idt}}(x,G_{H2O}(x))
+ \mathcal{L}_{\text{idt}}(y,G_{O2H}(y))
\Big)
\end{aligned}
\end{equation}
```
...
\begin{equation}
\begin{align}
	l_{total} &= l_{cyclegan}(x,y)  \\
	&+  \gamma( l_{cos}(label(x), cls(\hat{y})) +  l_{cos}(label(y), cls(\hat{x})))\\
\end{align}
\end{equation}
...
```math
	\begin{align}
		l_{total} &= l_{cyclegan}(x,y)  \\
		&+ \gamma( l_{cos}(cls(x), cls(\hat{y})) + l_{cos}(cls(y), cls(\hat{x})))\\
	\end{align}
```
